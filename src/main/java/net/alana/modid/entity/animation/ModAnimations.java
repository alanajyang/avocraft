package net.alana.modid.entity.animation;
...
public class ModAnimations {
    public static final Animation AVO_WALK = Animation.Builder.create(1f).looping()
    ...
    public static final Animation AVO_ATTACK = Animation.Builder.create(1.25f)
            ...
            .addBoneAnimation("body",
                    new Transformation(Transformation.Targets.SCALE,
                            ...
                            new Keyframe(0.375f, AnimationHelper.createScalingVector(1f, 1f, 1f),
                                    Transformation.Interpolations.LINEAR),
                            new Keyframe(0.5834334f, AnimationHelper.createScalingVector(1f, 1.2f, 1.2f),
                                    Transformation.Interpolations.LINEAR),
                            new Keyframe(0.7916766f, AnimationHelper.createScalingVector(1f, 1f, 1f),
                                    Transformation.Interpolations.LINEAR))).build();
    public static final Animation AVO_IDLE = Animation.Builder.create(1f).looping()
            .addBoneAnimation("body",
